...
uint8_t Device::read_from_memory(uint16_t location) {
    return rom[location];
}

void Device::write_to_memory(uint16_t location, uint8_t value) {
    rom[location] = value;
}
...
uint16_t Device::STOP() {
    // TODO: Make stop wait for button press
    return cpu.pc + 1;
}

uint16_t Device::HALT() {
    // TODO: Make halt wait for button press
    return cpu.pc + 1;
}

// -----------------------------------------------
// Two Register Operation Functions
// -----------------------------------------------

void Device::INC_16bit(std::string double_register) {
...
void Device::INC_address(std::string double_register) {
...
void Device::DEC_16bit(std::string double_register) {
...
void Device::DEC_address(std::string double_register) {
...
uint16_t Device::LD_16bit(std::string double_register) {
...
uint16_t Device::LD_16bit_to_next(std::string double_register) {
...
uint16_t Device::LD_8bit_to_address(std::string address_register) {
    uint16_t address;
...
// -----------------------------------------------
// One Register Operation Functions
// -----------------------------------------------


void Device::INC_8bit(std::string in_register) {
...
void Device::DEC_8bit(std::string in_register) {
...
uint16_t Device::LD_8bit(std::string in_register) {
...
uint16_t Device::LD_8bit_from_register(std::string in_register, std::string load_register) {
...
uint16_t Device::LD_8bit_from_address(std::string in_register, std::string address_register) {
...
uint16_t Device::LD_8bit_from_address(std::string in_register, std::string symbol, std::string address_register) {
    ...
    if (symbol == "+") {
        INC_16bit(address_register);
    } else {
        DEC_16bit(address_register);
    }

    return cpu.pc + 1;
}

uint16_t Device::LD_8bit_to_address(std::string address_register, std::string load_register) {
...
uint16_t Device::LD_8bit_to_address(std::string address_register, std::string symbol, std::string load_register) {
...
void Device::RLC(std::string in_register) {
...
void Device::RL(std::string in_register) {
    auto register_value = cpu.registers[in_register];
...
void Device::RRC(std::string in_register) {
    auto register_value = cpu.registers[in_register];
...
void Device::RR(std::string in_register) {
    auto register_value = cpu.registers[in_register];
